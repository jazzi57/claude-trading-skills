...
| [Chart Pattern Scanner]({{ '/en/skills/chart-pattern-scanner/' | relative_url }}) | This skill should be used when scanning candlestick charts for classic patterns (engulfing, hammer, doji, morning/eve... | <span class="badge badge-free">No API</span> |
...
| [Discord Whatsapp Bridge]({{ '/en/skills/discord-whatsapp-bridge/' | relative_url }}) | Set up and operate a Discord-to-WhatsApp bridge that forwards trading alerts from Discord channels to a WhatsApp number | <span class="badge badge-free">No API</span> |
