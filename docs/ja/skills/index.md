...
| [Discord Whatsapp Bridge]({{ '/ja/skills/discord-whatsapp-bridge/' | relative_url }}) | Set up and operate a Discord-to-WhatsApp bridge that forwards trading alerts from Discord channels to a WhatsApp number | <span class="badge badge-free">API不要</span> |
